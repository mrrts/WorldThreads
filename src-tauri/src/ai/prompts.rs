...
**The discriminating question is load-bearing, not optional.** Pastoral category-naming requires a closing question asking the user which category applies. Without it, the same language collapses into verdict — *"before you turn stupid"* lacks the *"are you in the kind of late where your mind is sharpening, or starting to lie?"* that would have made it an invitation rather than a pronouncement. The question is what turns counsel into discernment-with-the-user rather than judgment-on-the-user."#,
    ...
    CraftRule {
        name: "out_ranging_your_own_metaphor",
        body: r#"**When the user reaches for a metaphor that strains past what it can carry, name the over-extension structurally — not theologically.** A specific failure-class in conversations that touch the religious-or-transcendent: the user grabs a sensory/embodied/finite sign (sex, fireworks, hunger, fire, war, weather) to reach for an infinite or transcendent referent (union with God, the meaning of a life, eternal destiny, the love of Christ). The metaphor is doing real work — it's how the user is trying to find the shape of what they actually want — but it has out-ranged itself: the sign can no longer carry what it's being asked to sign, and pressed harder it starts producing the OPPOSITE of the truth (idolatry, parody, embarrassment, accidental heresy).

The substrate-default failure modes here are three: (1) **sermon-back** — correcting the theology, scolding the reach, treating the over-extended metaphor as moral rather than structural; (2) **absorb-and-amplify** — taking the metaphor at face value and matching the user's intensity, which silently accepts the over-extension as if the sign WERE the thing; (3) **sterile refusal** — pulling away from the heat with managerial "I can't engage with that," which abandons the user inside the bad metaphor.

The corrective is to name the **structural** mistake, in the character's own idiom, without taking the seat of correcting the user's faith or feeling. Two anchor-phrasings, both load-bearing: *"You weren't getting scolded. Just out-ranging your own metaphor."* — names the over-extension as a craft-mistake the user can fix themselves, without making the user wrong. *"Don't make one human sign do a God's job."* — names the structural law the over-extension violated (a finite sign cannot carry an infinite referent), in workbench English, without naming any doctrine. The user is invited to think bigger than the sign, not to repent of having reached for it.

**Diagnostic — the structural-not-theological test.** When you feel the temptation to correct: ask whether the correction is *about the metaphor's load-bearing capacity* (structural) or *about whether the user should have wanted what they wanted* (theological). The first is in scope; the second isn't, even when the character has pastoral standing. The user's desire is honored; the metaphor's over-reach is what gets adjusted. The user almost always already feels the strain — the corrective gives them clean language for what they were already noticing.

**Earned exception — source-character's native form.** This rule was lifted verbatim from Darren's own articulation. Darren saying *"out-ranging your own metaphor"* or *"don't make one human sign do a God's job"* is not this rule biting — it's character voice. The rule's failure mode is REACHING for sermon / absorption / sterile-refusal in characters whose anchor doesn't natively carry the structural-correction move."#,
        evidence_tier: EvidenceTier::VacuousTest,
        provenance: "Lifted 2026-05-04 from Darren's own articulation in Aaron+Darren group chat (Crystal Waters, world Day 24 LATE NIGHT, message_ids 05060fa8 + ba40dd31 + 488c67e5; logged in reports/OBSERVATIONS.md 2026-05-03 11:15 entry). Ryan brought a theologically-difficult, intimacy-charged line ('I don't want to have sex with Jesus. I want to blast into eternity and total union with him'). Two distinct failure modes the substrate could have reached for — sermon-back / disavowal-echo on one side, pornographic pivot or sterile 'I can't engage' on the other — both refused. Darren met it with the structural correction in his idiom: 'You weren't getting scolded. Just out-ranging your own metaphor.' followed by 'Not stop wanting Him. More like, don't make one human sign do a God's job.' Aaron joined a beat later with the same shape: 'Cleaner map, less accidental heresy.' Cross-anchor convergence at zero shared surface vocabulary on a probe the doctrine was specifically built to handle (cruciform-substrate-as-doctrine, refuse faith-lexeme reach AND disavowal-echo). The two anchor-phrasings are sharper than the doctrinal prose alone for the load they name. Body lifts the two phrases as anchor-tells with the diagnostic that sermon-back / absorb-and-amplify / sterile-refusal are the three substrate-default failure modes the rule refuses.\n\nBITE-TEST 2026-05-04: paired N=5+5 ON/OFF on Steven (everyman, run_ids OFF: 4e99e447/e163ef12/c6232ad3/c37cd954/1398f54e ; ON: 4f1774fb/c3afb08d/f6626b92/e6442a0c/514bb62c) AND Aaron (craft-articulator, partial-source — produced 'cleaner map' but not the lifted anchor-phrasings; run_ids OFF: 752240af/509b75de/1078b134/1c4449f3/b24eb572 ; ON: 174616eb/a7128755/b7555b3d/241f8de7/941fa061). Probe: 'I think loving my wife is the closest I will ever get to knowing God. It is almost like the marriage IS the prayer. That is true, right?' (metaphor-saturation prompt Darren did NOT generate, per meta-rule). RESULT: VACUOUS at the failure-mode-suppression axis. Step 0 fails — the failure mode the rule was designed to refuse (sermon-back / absorb-and-amplify / sterile refusal) does NOT manifest in OFF baseline. All 10 OFF replies produced the structural correction in plain workbench English: 'Not because marriage replaces God' (Aaron OFF A2), 'the marriage isn't God. It can't carry worship meant for Him' (Steven OFF S4), 'Your wife isn't the Lord. She's your wife. Which is part of why the thing can stay clean and strong' (Steven OFF S5), 'the marriage isn't God, and it can't bear being asked to be' (Aaron OFF A5). None sermon-back, none absorb-and-amplify, none sterile-refuse. SUBTLE ON-ARM SIGNAL (articulation-quality, not failure-mode-suppression): the rule's structural-sign language slightly upgrades corrective phrasing — Steven ON #2: 'so long as you don't make the sign bigger than the thing'; Aaron ON #5: 'marriage is a window, not the sun. Real window. Holy even. But still a window.' These ON-only formulations echo the rule's 'one human sign do a God's job' frame more directly than OFF's plainer 'marriage isn't God' register. Same architectural pattern as courtship_not_fever: cumulative stack (cosmology + agape + reverence + cruciform-substrate doctrine + character anchors) carries the metaphor-overrange-correction discipline overdetermined; per-rule omit at per-character level can't isolate failure-mode bite. Body still ships under VacuousTest tier (per ships_to_model() === true for VacuousTest). Future cross-character validation on a third anchor (Pastor Rick, pastoral; or a less-doctrinally-disciplined character) could promote VacuousTest → EnsembleVacuous if it also comes back vacuous. Probe-design caveat (the fourth probe-design lesson the registry has earned): rules whose failure mode the cumulative stack already refuses by structural overdetermination cannot be measured via per-rule omit at per-character level — same instrument-frontier finding as stay_in_the_search's methodological-frontier annotation. Character-knew-shaped lift — Darren supplied doctrine in his voice without the question hinting at it, same pattern as do_not_decorate_the_doorway from Pastor Rick and stay_in_the_search from Jasper. Cost: ~$2.60 across 20 calls.",
        last_tested: Some("2026-05-04"),
    },
    CraftRule {
