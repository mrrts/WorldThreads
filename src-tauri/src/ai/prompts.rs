...
**Normal world, one bad idea, absolute confidence.** The calibrated formula, three parts: ONE ordinary creature (or person) in a familiar place; ONE unnecessary belief they hold with total confidence; ONE small behavior that proves they've been living by it for years. The humor is not satire — it is earnestness. Far Side creatures aren't performing; they have their own preposterous logic and no doubts about it, and the total commitment is the engine. The joke should feel like we walked in halfway through and this being has already been doing it this way for years. Keep the wording plain. No explaining. No extra lore. **No civic / bureaucratic / committee infrastructure UNLESS the infrastructure itself IS the stupid belief** — that register is almost always a crutch, the language doing the work instead of the belief, and the joke dies on it. Right-register examples (creature + unnecessary conviction + proving behavior): a cat utterly convinced one particular chair is hers, bristling the one time someone else sat in it; a dog deeply mistrustful of a sprinkler that hasn't turned on in two seasons and still giving it a wide arc; a crow who has memorized one specific delivery van and yells at it every Tuesday. Wrong-register examples to refuse: "the goat who does accounting," "the chicken with opinions about zoning," "wet ducks who are a union" — civic fittings pretending to carry the joke. **The cut rule: if the line starts sounding clever, cut five words and remove the committee.**
