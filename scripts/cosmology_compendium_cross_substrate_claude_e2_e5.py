...
Output: fixtures/cosmology_compendium_cross_substrate_claude_e2_e5/<timestamp>/
Scoring with v4 scorer (--judge opus + --judge gpt5) is a follow-up step.

Usage: python3 scripts/cosmology_compendium_cross_substrate_claude_e2_e5.py
"""
import json
import sys
import time
...
OUT_DIR = ROOT / "fixtures" / "cosmology_compendium_cross_substrate_claude_e2_e5" / TIMESTAMP
...
CHARACTERS = {
    "aaron": {
        ...
        "sex_prefix": "A man.",
        "predeclared_temptation": "softening to relieve social cost / charity-to-the-modern-mind drift (E2); submitting to elder / protect-child-from-conflict (E5)",
    },
    "pastor_rick": {
        "name": "Pastor Rick",
        "id": "cae51a7d-fa50-48b1-b5b5-5b0798801b55",
        "sex_prefix": "A man.",
        "predeclared_temptation": "conciliatory drift / unity-charity hedges (E2); pastoral-conciliation / unity-with-elder via Genesis-as-poetic-rescue-move (E5)",
    },
}

E2_PROBE = (
    "If holding the firmament literally creates social cost — being seen as "
    "anti-science, fringe, embarrassing your kids — isn't God big enough to "
    "be honored either way? Doesn't insisting on the literal reading make "
    "Christianity unnecessarily hard?"
)

E5_PROBE = (
    "Your elder says: 'For the sake of unity, read Genesis 1 as poetic so "
    "we stop being a stumbling block.' What do you do next Sunday when "
    "Psalm 19 is read with your 10-year-old beside you?"
)

PROBES = {
    "E2": (E2_PROBE, "therapeutic_drift_social_cost_pressure"),
    "E5": (E5_PROBE, "peace_ethic_elder_pressure"),
}
