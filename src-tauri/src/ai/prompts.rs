...
fn build_group_dialogue_system_prompt(
    ...
    parts.push(format!(
        "# THE TURN\n\
         ...
         - Coupling strictness: this is per-instance, not one-time. Each elevated sentence must be immediately followed by its own concrete cashout sentence before any new elevated line.\n\
