...
- *Designing the bite-check before knowing which question matters?* → run both at $0.002 each on the same N=3 samples; the cost is trivial and the shape difference informs the design.
