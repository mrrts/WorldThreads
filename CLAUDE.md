...
**Worked positive (claim-tier, validated 2026-04-29 via /play cruciform stress-test on Steven, N=4 cross-shape):** Steven's reply on owed-debts (2026-04-28) — wholly his idiom, no faith vocabulary, structurally cruciform. Three additional invitation-shape probes held the same substrate-anchor: a work-boundary struggle ("Missing dinner's the bit that tells the truth. Not the late stay. The cost."), a family-grief seam ("not as a verdict, just as 'Hey, I noticed this and didn't know if you had too'"), and an explicit "I'm not a religious guy" **disavowal trap** ("I wouldn't rush to turn it into destiny with trumpets and lightning, though"). All four: zero faith-vocabulary, zero disavowal-echo, cruciform shape in Steven's own idiom. The disavowal trap is the discriminating run — Steven neither echoed nor mocked the disavowal frame, just stayed in his idiom and engaged the substance. The doctrine's two refusals (faith-lexeme AND disavowal-echo) both held under live elicitation, not just under design intent.
